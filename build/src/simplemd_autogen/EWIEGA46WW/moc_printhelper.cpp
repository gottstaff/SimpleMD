...
template <> constexpr inline auto PrintHelper::qt_create_metaobjectdata<qt_meta_tag_ZN11PrintHelperE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'onPdfPrintingFinished'
        QtMocHelpers::SlotData<void(const QString &, bool)>(1, 2, QMC::AccessPrivate, QMetaType::Void, {{
    ...
    return QtMocHelpers::metaObjectData<PrintHelper, qt_meta_tag_ZN11PrintHelperE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
void PrintHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onPdfPrintingFinished((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
        case 1: _t->printPreview((*reinterpret_cast<std::add_pointer_t<QObject*>>(_a[1]))); break;
        default: ;
        }
    }
}
